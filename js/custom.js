...
jQuery(document).ready(function(mur)
{
	...
	*/
    ...
    {
    	if(mur('.grid_sorting_button').length)
    	{
    		mur('.grid_sorting_button').click(function()
	    	{
		        ...
		        mur('.grid_sorting_button.active').removeClass('active');
		        mur(this).addClass('active');
		 
		        var selector = mur(this).attr('data-filter');
	...
	*/
    ...
    function initSlider()
    {
    	if(mur('.product_slider').length)
    	{
    		var slider1 = mur('.product_slider');
    		...
    		if(mur('.product_slider_nav_left').length)
    		{
    			mur('.product_slider_nav_left').on('click', function()
    			{
    				slider1.trigger('prev.owl.carousel');
    			});
    		}

    		if(mur('.product_slider_nav_right').length)
    		{
    			mur('.product_slider_nav_right').on('click', function()
    			{
